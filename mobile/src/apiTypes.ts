...
export interface AppointmentDto { id: string; businessId: string; customerId: string | null; assignedMemberId: string | null; serviceName: string; startsAt: string; endsAt: string; status: AppointmentStatus; price: string | number | null; notes: string | null; reminderMinutes: number | null; createdAt: string; updatedAt: string; customer?: Pick<CustomerDto, 'id' | 'name' | 'phone' | 'email'> | null; assignedMember?: { id: string; user: { id: string; fullName: string; email: string } } | null; }
