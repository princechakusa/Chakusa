...
export interface AppointmentDto { id: string; businessId: string; customerId: string | null; assignedMemberId: string | null; serviceOfferingId: string | null; serviceName: string; startsAt: string; endsAt: string; status: AppointmentStatus; price: string | number | null; depositAmount?: string | number | null; paidAmount?: string | number; paymentStatus?: LeadPaymentStatus; notes: string | null; reminderMinutes: number | null; confirmationSentAt?: string | null; customerReminderSentAt?: string | null; paymentReminderSentAt?: string | null; createdAt: string; updatedAt: string; customer?: Pick<CustomerDto, 'id' | 'name' | 'phone' | 'email'> | null; assignedMember?: { id: string; user: { id: string; fullName: string; email: string } } | null; serviceOffering?: ServiceOfferingDto | null; paymentTransactions?: AppointmentPaymentTransactionDto[]; }
export interface ServiceOfferingDto { id: string; businessId: string; name: string; description: string | null; durationMinutes: number; preparationMinutes: number; cleanupMinutes: number; price: string | number | null; depositAmount: string | number | null; active: boolean; publiclyBookable: boolean; sortOrder: number; assignments: { businessMemberId: string; businessMember: { id: string; user: { id: string; fullName: string; email: string } } }[]; createdAt: string; updatedAt: string; }
