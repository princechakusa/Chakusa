...
export function StatusBadge({ label }: { label: string }) {
  const tone = ['Won', 'Reviewed', 'Completed', 'Active', 'Booked', 'Customer Returned'].includes(label) ? 'success' : ['Lost', 'Feedback', 'Dismissed', 'Dormant'].includes(label) ? 'negative' : ['New', 'Pending', 'Due', 'Due back', 'Ready today', 'Payment Outstanding', 'Waiting For Review', 'Waiting For Follow Up', 'Reminder Scheduled'].includes(label) ? 'attention' : 'neutral';
