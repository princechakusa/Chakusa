...
describe('trust and settings configuration', () => {
  ...
  it('uses the approved public legal and support identities', () => { expect(APPROVED_PUBLIC_DESTINATIONS).toEqual({ privacy: 'https://chakusarecovery.com/privacy', terms: 'https://chakusarecovery.com/terms', cookies: 'https://chakusarecovery.com/cookies', aiDisclosure: 'https://chakusarecovery.com/ai-disclosure', support: 'https://chakusarecovery.com/help', deleteAccount: 'https://chakusarecovery.com/delete-account', supportEmail: 'support@chakusarecovery.com' }); });
});
