...
export function DashboardScreen() {
  ...
  return <Screen>
    ...
    <View>
      ...
      </View> : <EmptyState title="Nothing needs attention yet" message={dashboard.leads.total === 0 && dashboard.reviews.requestsSent === 0 ? 'Add your first lead or customer to start your recovery workflow.' : "You're caught up for today."} />}
    </View>
