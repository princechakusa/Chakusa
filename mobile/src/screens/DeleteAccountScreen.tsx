...
export function DeleteAccountScreen() {
  const { user, business, deleteAccount, deleteAccountWithGoogle, deleteAccountWithApple } = useAuth(); const [password, setPassword] = useState(''); const [loading, setLoading] = useState<'password' | 'google' | 'apple' | null>(null); const [error, setError] = useState<string | null>(null);
