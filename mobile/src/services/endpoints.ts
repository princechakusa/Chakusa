...
export const invoicesApi = {
  ...
  paymentLink: (id: string) => api.post<InvoicePaymentLinkResult>(`/invoices/${id}/payment-link`, {}),
  payments: (id: string) => api.get<InvoicePaymentTransactionDto[]>(`/invoices/${id}/payments`),
  refundPayment: (id: string, paymentId: string, amount?: number) =>
    api.post<InvoicePaymentTransactionDto>(`/invoices/${id}/payments/${paymentId}/refund`, amount != null ? { amount } : {}),
};
