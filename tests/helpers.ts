...
export async function resetDatabase() {
  ...
  await prisma.$transaction([
    ...
    prisma.attachmentProcessingEvent.deleteMany(),
    ...
    prisma.providerCredentialAudit.deleteMany(),
    prisma.providerHealthSample.deleteMany(),
    ...
    prisma.aIEvaluationResult.deleteMany(),
    prisma.aIEvaluationRun.deleteMany(),
    prisma.aIEvaluationCase.deleteMany(),
    prisma.aIEvaluationSuite.deleteMany(),
    prisma.aIAttributedOutcome.deleteMany(),
    prisma.aIOperationalMetric.deleteMany(),
    prisma.aIProviderHealthCheck.deleteMany(),
    prisma.aIRetrievalLog.deleteMany(),
    prisma.aIMemorySession.deleteMany(),
    prisma.aIMemoryRecord.deleteMany(),
    prisma.aIPolicyDecision.deleteMany(),
    prisma.aIPolicyChange.deleteMany(),
    prisma.aIPolicyRule.deleteMany(),
    prisma.aIPolicy.deleteMany(),
    prisma.promptTestRun.deleteMany(),
    prisma.promptTestCase.deleteMany(),
    prisma.promptApproval.deleteMany(),
    prisma.promptDeployment.deleteMany(),
    prisma.promptLocalization.deleteMany(),
    prisma.promptVariable.deleteMany(),
    prisma.promptOverride.deleteMany(),
    prisma.promptVersion.deleteMany(),
    prisma.promptTemplate.deleteMany(),
    prisma.promptCategory.deleteMany(),
    prisma.promptPackage.deleteMany(),
    prisma.aIInvocationLedger.deleteMany(),
    prisma.aIConversationRun.deleteMany(),
    ...
    prisma.customerActivityEvent.deleteMany(),
    prisma.customerNotification.deleteMany(),
    prisma.customerRecentSearch.deleteMany(),
    prisma.businessReport.deleteMany(),
    prisma.businessFollow.deleteMany(),
    prisma.customerBusinessView.deleteMany(),
    ...
    prisma.loyaltyCampaign.deleteMany(),
    prisma.customerMembership.deleteMany(),
