...
export const footerGroups = [
  ...
  { title: "Features", links: [{ label: "Enquiries & leads", href: "/features/enquiries" }, { label: "Bookings", href: "/features/bookings" }, { label: "Reviews", href: "/features/reviews" }, { label: "Customers", href: "/features/customers" }, { label: "Retention", href: "/features/retention" }, { label: "Industries", href: "/industries" }] },
